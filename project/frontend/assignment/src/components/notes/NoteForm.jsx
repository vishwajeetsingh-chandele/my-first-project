...
const NoteForm = ({ 
  ...
  const [formData, setFormData] = useState({
    ...
    priority: note?.priority || NOTE_PRIORITIES.NORMAL
  })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await onSubmit({ ...formData, candidateId })
    } catch (error) {
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          >
            ...
            <option value={NOTE_TYPES.INTERVIEW_NOTE}>Interview Note</option>
        ...
        <div>
          ...
          >
            ...
            <option value={NOTE_PRIORITIES.NORMAL}>Normal</option>
            <option value={NOTE_PRIORITIES.HIGH}>High</option>
            <option value={NOTE_PRIORITIES.URGENT}>Urgent</option>
          </select>
        </div>
      </div>
